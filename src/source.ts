...
export function listSource() {
  return [
    ...
    ['fashionn.com', '패션엔'],
    ['feedapi.cloud.sbs.co.kr', 'SBS Golf'],
    ...
    ['m.sports.naver.com/basketball/article/065', '점프볼'],
    ['magazine.hankyung.com/business', '한경비즈니스'],
    ['magazine.hankyung.com/job-joy', '한경잡앤조이'],
    ['magazine.hankyung.com/money', '한경머니'],
    ['maisonkorea.com', '메종'],
    ...
    ['redaily.co.kr', '철도경제신문'],
    ['redian.org', '레디앙'],
    ['rightknow.co.kr', '알티케이뉴스'],
    ...
    ['tleaves.co.kr', '더리브스'],
    ['todayeconomic.com', '투데이e코노믹'],
    ['todayenergy.kr', '투데이에너지'],
    ['todaykorea.co.kr', '투데이코리아'],
    ['tokenpost.kr', '토큰포스트'],
    ['tongilnews.com', '통일뉴스'],
    ['topclass.chosun.com', 'topclass'],
    ['topdaily.kr', '톱데일리'],
